...
export class BasicFluidModule implements WebGLModule {
  ...
  private drawInQueue: boolean = false;
    ...
    const onPaste = (event: ClipboardEvent) => {
      clipboardToTexture(this.gl, event).then(
        (texture: WebGLTexture | undefined) => {
          ...
          // alpha,
          // rBeta,
          const jacobiShader = new JacobiShader(this.gl, wrapType);
