...
import add_frag from "./shaders/texture_add.frag?raw";
import texture_vert from "./shaders/texture.vert?raw";

export class AddKernel implements WebGLContinueKernel {
  ...
  constructor(
    ...
    this.program = compileShaders(this.gl, texture_vert, add_frag);
