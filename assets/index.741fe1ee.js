var ge=Object.defineProperty;var xe=(t,e,i)=>e in t?ge(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var o=(t,e,i)=>(xe(t,typeof e!="symbol"?e+"":e,i),i);import{r as P,j as q,A as fe,a as x,b as pe,T as G,c as ve,C as me,S as ne,B as _e,F as we,I as ye,d as be,M as Te,R as H,e as Re}from"./vendor.84f156a2.js";const Se=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function i(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerpolicy&&(s.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?s.credentials="include":n.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(n){if(n.ep)return;n.ep=!0;const s=i(n);fetch(n.href,s)}};Se();class j{draw(e,i){const r=0;var n=this.points.length;e.usePositions(this.points),e.use(),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,i),this.gl.drawArrays(this.primitive,r,n)}}class _ extends j{constructor(e){super();o(this,"points");o(this,"primitive");this.gl=e;let i=[new g(0,0),new g(1,0),new g(1,1)],r=[new g(0,1),new g(0,0),new g(1,1)];this.points=i.concat(r),this.primitive=this.gl.TRIANGLES}}var Ee=`#version 300 es
#ifdef GL_ES
